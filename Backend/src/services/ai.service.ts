...
export class AIService {
    async interactuarChatbot(mensaje: string, usuario_id?: string) {
        try {
    ...
    async getRecomendaciones(usuario_id?: string, producto_actual_id?: string) {
        try {
    ...
    async getPrecioDinamico(componente_id: string, precio_base: number, stock: number) {
        try {
